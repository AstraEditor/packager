  ...
  <Section accent="#4C97FF">
    ...
    <div class="options">
      ...
      <div class="option file-input-option">
        ...
        <label class="file-input-wrapper" style="--file-input-label: '{$_('select.chooseFile')}'; --file-input-name: '{selectedFileName}'">
          <input
            hidden={$type !== "file"}
...
<style>
  ...
  .file-input-wrapper::before {
    content: var(--file-input-label, "Choose File");
    display: inline-block;
    padding: 4px 12px;
    border-radius: 4px;
    background: #4C97FF;
